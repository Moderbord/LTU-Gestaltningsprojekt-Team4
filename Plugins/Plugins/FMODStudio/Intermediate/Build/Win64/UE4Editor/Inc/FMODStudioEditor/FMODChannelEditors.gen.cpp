...
static struct FScriptStruct_FMODStudioEditor_StaticRegisterNativesFFMODEventControlKeyStruct
{
...
#endif
	const UE4CodeGen_Private::FEnumPropertyParams Z_Construct_UScriptStruct_FFMODEventControlKeyStruct_Statics::NewProp_Value = { "Value", nullptr, (EPropertyFlags)0x0010000000000001, UE4CodeGen_Private::EPropertyGenFlags::Enum, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FFMODEventControlKeyStruct, Value), Z_Construct_UEnum_FMODStudio_EFMODEventControlKey, METADATA_PARAMS(Z_Construct_UScriptStruct_FFMODEventControlKeyStruct_Statics::NewProp_Value_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FFMODEventControlKeyStruct_Statics::NewProp_Value_MetaData)) };
	...
	const UE4CodeGen_Private::FStructParams Z_Construct_UScriptStruct_FFMODEventControlKeyStruct_Statics::ReturnStructParams = {
		...
		UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FFMODEventControlKeyStruct_Statics::PropPointers),
		RF_Public|RF_Transient|RF_MarkAsNative,
		EStructFlags(0x00000001),
		METADATA_PARAMS(Z_Construct_UScriptStruct_FFMODEventControlKeyStruct_Statics::Struct_MetaDataParams, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FFMODEventControlKeyStruct_Statics::Struct_MetaDataParams))
	};
	...
	uint32 Get_Z_Construct_UScriptStruct_FFMODEventControlKeyStruct_Hash() { return 1168482740U; }
